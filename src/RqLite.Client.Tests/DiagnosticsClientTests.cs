...
namespace RqLite.Client.Tests
{
    ...
    {
#if CLUSTERTEST
        private static string rqLiteEndpoint = "http://127.0.0.1:4001,http://127.0.0.1:4003,http://127.0.0.1:4005";
#else
        private static string rqLiteEndpoint = "http://127.0.0.1:4001";
#endif
